...
********************************************************************************
		...
		C_MOVE	fmode,%0000000000000001		;bpl 32 bit fetch

		C_WAIT	15,0,$fffe

		C_MOVE	bplcon0,%1101000000000100	;5 bitplanes hires lace
		C_MOVE	bplcon1,0			;no playfield scrolls
		C_MOVE	bplcon2,%0000000000000000       ;sprites behind playfield
		C_MOVE	bpl1mod,(((2624-640)+2624)/8)-4
		C_MOVE	bpl2mod,(((2624-640)+2624)/8)-4
		C_MOVE	ddfstrt,6<<3
		C_MOVE	ddfstop,26<<3
		C_MOVE	diwstrt,$2181
		C_MOVE	diwstop,$ffc1
		...
		C_MOVE	bplcon1,0			;no playfield scrolls
		C_MOVE	bplcon2,%0000000000000000	;sprites behind playfield
		C_MOVE	bpl1mod,80-4			;interlace modulo
		C_MOVE	bpl2mod,80-4			;no modulo
		C_MOVE	ddfstrt,6<<3
		C_MOVE	ddfstop,26<<3
		C_MOVE	diwstrt,$2181
		C_MOVE	diwstop,$fbc1
