;script before
;copy 3dgame:graphics/style2/ilbm/stairs.ilbm ram:output.ilbm
;copy work:c/ilbm2raw ram:
;
;ram:ilbm2raw -b4cmf240,53,32,36 ram:output.ilbm ram:temp1
;ram:ilbm2raw -b4cmf240,292,32,2 ram:output.ilbm ram:temp2
;ram:ilbm2raw -b4cmf208,47,48,2 ram:output.ilbm ram:temp3
...
;copy ram:test 3dgame:graphics/style2/raw/Stairs2right.bin
;script end
...
bob_structure	dc.l    0	;address of image data
	...
	IFD	dump
	incbin	"3dgame:graphics/style2/dump/stairs2right.dump"
        ENDC
