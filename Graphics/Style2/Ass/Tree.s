;script before
;copy 3dgame:graphics/style2/ilbm/Tree.ilbm ram:output.ilbm
;copy work:c/ilbm2raw ram:
;
;ram:ilbm2raw -mb4cf0,0,64,119 ram:output.ilbm ram:temp1
;ram:ilbm2raw -mb4cf64,0,48,86 ram:output.ilbm ram:temp2
;ram:ilbm2raw -mb4cf112,0,32,59 ram:output.ilbm ram:temp3
;ram:ilbm2raw -mb4cf144,0,32,41 ram:output.ilbm ram:temp4
...
;copy ram:test 3dgame:graphics/style2/raw/Tree.bin
;script end
...
bob_structure	dc.l    0	;address of image data
	...
	IFD	dump
	incbin	"3dgame:graphics/style2/dump/Tree.dump"
        ENDC
