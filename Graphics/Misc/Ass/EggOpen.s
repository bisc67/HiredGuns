...
;
;ram:ilbm2raw -mb4cf32,0,32,38 ram:output.ilbm ram:temp1
;ram:ilbm2raw -mb4cf32,38,16,22 ram:output.ilbm ram:temp2
;ram:ilbm2raw -mb4cf32,60,16,15 ram:output.ilbm ram:temp3
;ram:ilbm2raw -mb4cf32,75,16,12 ram:output.ilbm ram:temp4
...
;copy ram:test 3dgame:graphics/misc/raw/EggOpen.bin
;script end
...
bob_structure	dc.l    0	;address of image data
	...
	IFD	dump
	incbin	"3dgame:graphics/misc/dump/Egg.dump"
        ENDC
