;script before
;work:c/ilbm2raw -cmf0,213,16,7 3dgame:graphics/misc/ilbm/windows.ilbm ram:output.bin
;script assemble
;devpac3-2.0:devpac/genam >ram:errors.txt ram:test.s
;script after
;work:c/strip ram:test 32 4
;copy ram:test 3dgame:graphics/misc/raw/LeaderOff.bin
;script end
...
bob_structure	dc.l    0	;address of image data
		dc.w	16	;width in pixels
		dc.w	7	;height in pixels
