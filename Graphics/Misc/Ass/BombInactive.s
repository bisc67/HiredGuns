...
;
;ram:ilbm2raw -mb4cf224,0,32,38 ram:output.ilbm ram:temp1
;ram:ilbm2raw -mb4cf224,38,16,22 ram:output.ilbm ram:temp2
;ram:ilbm2raw -mb4cf224,60,16,15 ram:output.ilbm ram:temp3
;ram:ilbm2raw -mb4cf224,75,16,12 ram:output.ilbm ram:temp4
;ram:ilbm2raw -mb4cf224,87,32,32 ram:output.ilbm ram:temp5
...
;copy ram:test 3dgame:graphics/misc/raw/BombInactive.bin
;script end
...
bob_structure	dc.l    0	;address of image data
	...
	DEFPOS	006,91,224,UNFLIPD			;position 44
