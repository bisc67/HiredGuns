;script before
;copy 3dgame:graphics/misc/ilbm/water4.ilbm ram:output.ilbm
;copy work:c/ilbm2raw ram:
;
;ram:ilbm2raw -cf80,0,32,25 ram:output.ilbm ram:temp1
;ram:ilbm2raw -cf112,0,32,25 ram:output.ilbm ram:temp2
;ram:ilbm2raw -cf144,0,32,25 ram:output.ilbm ram:temp3
;ram:ilbm2raw -cf176,0,32,25 ram:output.ilbm ram:temp4
;ram:ilbm2raw -cf208,0,32,25 ram:output.ilbm ram:temp5
;ram:ilbm2raw -cf64,44,48,31 ram:output.ilbm ram:temp6
;ram:ilbm2raw -cf112,44,48,31 ram:output.ilbm ram:temp7
;ram:ilbm2raw -cf160,44,32,31 ram:output.ilbm ram:temp8
;join ram:temp1 ram:temp2 ram:temp3 ram:temp4 ram:temp5 ram:temp6 ram:temp7 ram:temp8 as ram:output.bin
;
;ram:ilbm2raw -cf192,44,48,31 ram:output.ilbm ram:temp1
;ram:ilbm2raw -cf240,44,48,31 ram:output.ilbm ram:temp2
...
;ram:ilbm2raw -cf32,78,16,14 ram:output.ilbm ram:temp5
;ram:ilbm2raw -cf64,76,48,16 ram:output.ilbm ram:temp6
;ram:ilbm2raw -cf112,76,48,16 ram:output.ilbm ram:temp7
...
;ram:ilbm2raw -cf288,78,16,14 ram:output.ilbm ram:temp3
;ram:ilbm2raw -cf48,151,32,23 ram:output.ilbm ram:temp4
;ram:ilbm2raw -cf80,150,64,24 ram:output.ilbm ram:temp5
;ram:ilbm2raw -cf144,150,48,24 ram:output.ilbm ram:temp6
;ram:ilbm2raw -cf192,150,64,24 ram:output.ilbm ram:temp7
;ram:ilbm2raw -cf256,151,32,23 ram:output.ilbm ram:temp8
;join ram:output.bin ram:temp1 ram:temp2 ram:temp3 ram:temp4 ram:temp5 ram:temp6 ram:temp7 ram:temp8 as ram:temp_output
;delete ram:output.bin
;rename ram:temp_output as ram:output.bin
;
;ram:ilbm2raw -cf80,227,48,40 ram:output.ilbm ram:temp1
;ram:ilbm2raw -cf128,227,80,40 ram:output.ilbm ram:temp2
;ram:ilbm2raw -cf208,227,48,40 ram:output.ilbm ram:temp3
;ram:ilbm2raw -cf80,308,32,42 ram:output.ilbm ram:temp4
;ram:ilbm2raw -cf80,360,144,42 ram:output.ilbm ram:temp5
;ram:ilbm2raw -cf208,308,32,42 ram:output.ilbm ram:temp6
...
;
;strip ram:test 32
;copy ram:test 3dgame:graphics/misc/raw/Water4.bin
...
size	set	bob_struct_size+67*14
	...
	IFD	dump
	incbin	"3dgame:make/style1/dump/water1.dump"
	ENDC
