...
;work:c/ilbm2raw -mb4cf64,78,16,4 ram:output.ilbm ram:temp1
;work:c/ilbm2raw -mb4cf80,78,16,4 ram:output.ilbm ram:temp2
;work:c/ilbm2raw -mb4cf64,62,16,5 ram:output.ilbm ram:temp3
;work:c/ilbm2raw -mb4cf80,62,16,5 ram:output.ilbm ram:temp4
;work:c/ilbm2raw -mb4cf0,89,32,13 ram:output.ilbm ram:temp5
...
;copy ram:test 3dgame:graphics/style1/raw/Door1openside.bin
;script end
...
bob_structure	dc.l    0	;address of image data
	...
	IFD	dump
	incbin	"3dgame:graphics/style1/dump/Door1openside.dump"
        ENDC
