...
;work:c/ilbm2raw -mb4cf0,0,64,26 ram:output.ilbm ram:temp1
;work:c/ilbm2raw -mb4cf0,26,48,15 ram:output.ilbm ram:temp2
;work:c/ilbm2raw -mb4cf0,42,32,11 ram:output.ilbm ram:temp3
;work:c/ilbm2raw -mb4cf0,54,32,7 ram:output.ilbm ram:temp4
...
;copy ram:test 3dgame:graphics/style1/raw/Door1front.bin
;script end
...
bob_structure	dc.l    0	;address of image data
	...
	IFD	dump
	incbin	"3dgame:graphics/style1/dump/Door1front.dump"
        ENDC
