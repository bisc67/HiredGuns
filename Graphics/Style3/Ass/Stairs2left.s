...
;
;work:c/ilbm2raw -b4cmf160,53,32,36 ram:output.ilbm ram:temp1
;work:c/ilbm2raw -b4cmf208,44,48,2 ram:output.ilbm ram:temp2
;work:c/ilbm2raw -b4cmf240,295,32,2 ram:output.ilbm ram:temp3
...
;copy ram:test 3dgame:graphics/style3/raw/Stairs2left.bin
;script end
...
bob_structure	dc.l    0	;address of image data
	...
	DEF_BOB	48,2,32,82,0				;block 65
	DEF_BOB	32,2,111,82,0				;block 66

	ENDC

	IFD	dump
	incbin	"3dgame:graphics/style3/dump/Stairs2left.dump"
        ENDC
