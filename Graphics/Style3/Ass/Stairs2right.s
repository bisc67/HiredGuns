;script before
;copy 3dgame:graphics/style3/ilbm/stairs.ilbm ram:output.ilbm
;
;work:c/ilbm2raw -b4cmf240,53,32,36 ram:output.ilbm ram:temp1
;work:c/ilbm2raw -b4cmf240,292,32,2 ram:output.ilbm ram:temp2
;work:c/ilbm2raw -b4cmf208,47,48,2 ram:output.ilbm ram:temp3
;join ram:temp1 ram:temp2 ram:temp3 as ram:output.bin
;
;script assemble
...
;copy ram:test 3dgame:graphics/style3/raw/Stairs2right.bin
;script end
...
bob_structure	dc.l    0	;address of image data
	...
	DEF_BOB	32,36,111,6,0				;block 45
	...
	DEF_BOB	32,2,0,82,0				;block 64
	DEF_BOB	48,2,71,82,0				;block 65
	DEF_BOB	0,0,0,0,3				;block 66

	ENDC

	IFD	dump
	incbin	"3dgame:graphics/style3/dump/stairs2right.dump"
        ENDC
