...
********************************************************************************
		...
		dc.b	"003E origine inconnue",ENDTEXT,"           "	;char 1
		dc.b	"Clavius",ENDTEXT,"                         "
		dc.b	"Humanoãde, 176 ans",ENDTEXT,"              "
		dc.b	"Pilote",ENDTEXT,"                          "
		dc.b	"Clavius",ENDTEXT,"         "
		dc.b	"CharactersGfx/Clavius.gfx",ENDTEXT,"  "
		dc.b	2		;gender (0=male, 1=female, 2=n/a)
...
********************************************************************************
		...
		dc.b	"00-98CC Earth",ENDTEXT,"                   "	;char 2
		dc.b	"Siygess, Cheule",ENDTEXT,"                 "
		dc.b	"Humain femelle, 27 ans",ENDTEXT,"          "
		dc.b	"Citoyenne de la Terre",ENDTEXT,"           "
		dc.b	"Cheule",ENDTEXT,"          "
		dc.b	"CharactersGfx/Cheule.gfx",ENDTEXT,"   "
		dc.b	1		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"04-56FE Tesseract",ENDTEXT,"               "	;char 3
		dc.b	"MC 128-7 CIM",ENDTEXT,"                    "
		dc.b	"Machine, 6 ans",ENDTEXT,"                  "
		dc.b	"SÇrie infantrie de combat",ENDTEXT,"       "
		dc.b	"CIM",ENDTEXT,"             "
		dc.b	"CharactersGfx/CIM.gfx",ENDTEXT,"      "
		dc.b	2		;gender (0=male, 1=female, 2=n/a)
		dc.b	1		;race
...
********************************************************************************
		...
		dc.b	"01-A45D New Europe",ENDTEXT,"              "	;char 4
		dc.b	"Desverger",ENDTEXT,"                       "
		dc.b	"Humain mÉle, 42 ans",ENDTEXT,"             "
		dc.b	"Mercenaire",ENDTEXT,"                      "
		dc.b	"Desverger",ENDTEXT,"       "
		dc.b	"CharactersGfx/Desverger.gfx",ENDTEXT,""
		dc.b	0		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"07-0453 Cassandra",ENDTEXT,"               "	;char 5
		dc.b	"Reannon, Adele",ENDTEXT,"                  "
		dc.b	"Humain femelle, 31 ans",ENDTEXT,"          "
		dc.b	"Expert en systämes de sÇcuritÇ",ENDTEXT,"  "
		dc.b	"Adele",ENDTEXT,"           "
		dc.b	"CharactersGfx/Adele.gfx",ENDTEXT,"    "
		dc.b	1		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"00-0027 New Europe",ENDTEXT,"              "	;char 6
		dc.b	"Torre, Miyriel",ENDTEXT,"                  "
		dc.b	"Cyborg, 100 ans",ENDTEXT,"                 "
		dc.b	"SÇrie interface IV",ENDTEXT,"              "
		dc.b	"Miyriel",ENDTEXT,"         "
		dc.b	"CharactersGfx/Miyriel.gfx",ENDTEXT,"  "
		dc.b	2		;gender (0=male, 1=female, 2=n/a)
		dc.b	4		;race
...
********************************************************************************
		...
		dc.b	"Deevergh, Rorian",ENDTEXT,"                "
		dc.b	"Humain mÉle, 42 ans",ENDTEXT,"             "
		dc.b	"Combattant aguerri",ENDTEXT,"              "
		dc.b	"Rorian",ENDTEXT,"          "
		dc.b	"CharactersGfx/Rorian.gfx",ENDTEXT,"   "
		dc.b	0		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"A037 origine inconnue",ENDTEXT,"           "	;char 8
		dc.b	"Freymon, Jenillee",ENDTEXT,"               "
		dc.b	"Humain femelle, 27 ans",ENDTEXT,"          "
		dc.b	"MÇdecin de l'armÇe",ENDTEXT,"              "
		dc.b	"Jenillee",ENDTEXT,"        "
		dc.b	"CharactersGfx/Jenillee.gfx",ENDTEXT," "
		dc.b	1		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"04-154E Tesseract",ENDTEXT,"               "	;char 12
		dc.b	"Kiurcher",ENDTEXT,"                        "
		dc.b	"Humain mÉle, 49 ans",ENDTEXT,"             "
		dc.b	"Tireur d'Çlite",ENDTEXT,"                  "
		dc.b	"Kiurcher",ENDTEXT,"        "
		dc.b	"CharactersGfx/Kiurcher.gfx",ENDTEXT," "
		dc.b	0		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"08-32EE Starscape",ENDTEXT,"               "	;char 10
		dc.b	"Spey, Bonden",ENDTEXT,"                    "
		dc.b	"Humain mÉle, 22 ans",ENDTEXT,"             "
		dc.b	"Citoyen",ENDTEXT,"                         "
		dc.b	"Bonden",ENDTEXT,"          "
		dc.b	"CharactersGfx/Bonden.gfx",ENDTEXT,"   "
		dc.b	0		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"Homez, Katrina",ENDTEXT,"                  "
		dc.b	"Humain femelle, 27 ans",ENDTEXT,"          "
		dc.b	"Ancien agent UPBI",ENDTEXT,"               "
		dc.b	"Katrina",ENDTEXT,"         "
		dc.b	"CharactersGfx/Katrina.gfx",ENDTEXT,"  "
		dc.b	1		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"56-AA56 Freewill",ENDTEXT,"                "	;char 12
		dc.b	"CIM-Lite",ENDTEXT,"                        "
		dc.b	"Machine, 2 ans",ENDTEXT,"                  "
		dc.b	"SÇrie infanterie de combat",ENDTEXT,"      "
		dc.b	"CIM-Lite",ENDTEXT,"        "
		dc.b	"CharactersGfx/CIM-Lite.gfx",ENDTEXT," "
		dc.b	2		;gender (0=male, 1=female, 2=n/a)
		dc.b	1		;race
...
********************************************************************************
		...
		dc.b	"003E ursprung unbekannt",ENDTEXT,"         "	;char 1
		dc.b	"Clavius",ENDTEXT,"                         "
		dc.b	"Humanoider, 176 Jahre",ENDTEXT,"           "
		dc.b	"Pilot",ENDTEXT,"                           "
		dc.b	"Clavius",ENDTEXT,"         "
		dc.b	"CharactersGfx/Clavius.gfx",ENDTEXT,"  "
		dc.b	2		;gender (0=male, 1=female, 2=n/a)
...
********************************************************************************
		...
		dc.b	"00-98CC Earth",ENDTEXT,"                   "	;char 2
		dc.b	"Siygess, Cheule",ENDTEXT,"                 "
		dc.b	"Weibl. Mensch, 27 Jahre",ENDTEXT,"         "
		dc.b	"ErdenbÅrgerin",ENDTEXT,"                   "
		dc.b	"Cheule",ENDTEXT,"          "
		dc.b	"CharactersGfx/Cheule.gfx",ENDTEXT,"   "
		dc.b	1		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"04-56FE Tesseract",ENDTEXT,"               "	;char 3
		dc.b	"MC 128-7 CIM",ENDTEXT,"                    "
		dc.b	"Mech, 6 Jahre",ENDTEXT,"                   "
		dc.b	"Gefechtsinfanterieserie",ENDTEXT,"         "
		dc.b	"CIM",ENDTEXT,"             "
		dc.b	"CharactersGfx/CIM.gfx",ENDTEXT,"      "
		dc.b	2		;gender (0=male, 1=female, 2=n/a)
		dc.b	1		;race
...
********************************************************************************
		...
		dc.b	"01-A45D New Europe",ENDTEXT,"              "	;char 4
		dc.b	"Desverger",ENDTEXT,"                       "
		dc.b	"MÑnnl. Mensch, 42 Jahre",ENDTEXT,"         "
		dc.b	"Freischaffender Killer",ENDTEXT,"          "
		dc.b	"Desverger",ENDTEXT,"       "
		dc.b	"CharactersGfx/Desverger.gfx",ENDTEXT,""
		dc.b	0		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"07-0453 Cassandra",ENDTEXT,"               "	;char 5
		dc.b	"Reannon, Adele",ENDTEXT,"                  "
		dc.b	"Weibl. Mensch, 31 Jahre",ENDTEXT,"         "
		dc.b	"Expertin f. Sich.-syst.",ENDTEXT,"         "
		dc.b	"Adele",ENDTEXT,"           "
		dc.b	"CharactersGfx/Adele.gfx",ENDTEXT,"    "
		dc.b	1		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"00-0027 New Europe",ENDTEXT,"              "	;char 6
		dc.b	"Torre, Miyriel",ENDTEXT,"                  "
		dc.b	"Cyborg, 100 Jahre",ENDTEXT,"               "
		dc.b	"Interface IV Serie",ENDTEXT,"              "
		dc.b	"Miyriel",ENDTEXT,"         "
		dc.b	"CharactersGfx/Miyriel.gfx",ENDTEXT,"  "
		dc.b	2		;gender (0=male, 1=female, 2=n/a)
		dc.b	4		;race
...
********************************************************************************
		...
		dc.b	"A037 ursprung unbekannt",ENDTEXT,"         "	;char 8
		dc.b	"Freymon, Jenillee",ENDTEXT,"               "
		dc.b	"Weibl. Mensch, 27 Jahre",ENDTEXT,"         "
		dc.b	"FeldÑrztin",ENDTEXT,"                      "
		dc.b	"Jenillee",ENDTEXT,"        "
		dc.b	"CharactersGfx/Jenillee.gfx",ENDTEXT," "
		dc.b	1		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"04-154E Tesseract",ENDTEXT,"               "	;char 12
		dc.b	"Kiurcher",ENDTEXT,"                        "
		dc.b	"MÑnnl. Mensch, 49 Jahre",ENDTEXT,"         "
		dc.b	"SchÅtze",ENDTEXT,"                         "
		dc.b	"Kiurcher",ENDTEXT,"        "
		dc.b	"CharactersGfx/Kiurcher.gfx",ENDTEXT," "
		dc.b	0		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"08-32EE Starscape",ENDTEXT,"               "	;char 10
		dc.b	"Spey, Bonden",ENDTEXT,"                    "
		dc.b	"MÑnnl. Mensch, 22 Jahre",ENDTEXT,"         "
		dc.b	"BÅrger",ENDTEXT,"                          "
		dc.b	"Bonden",ENDTEXT,"          "
		dc.b	"CharactersGfx/Bonden.gfx",ENDTEXT,"   "
		dc.b	0		;gender (0=male, 1=female, 2=n/a)
...
********************************************************************************
		...
		dc.b	"Homez, Katrina",ENDTEXT,"                  "
		dc.b	"Weibl. Mensch, 27 Jahre",ENDTEXT,"         "
		dc.b	"Ehemaliger NDVP-Agent",ENDTEXT,"           "
		dc.b	"Katrina",ENDTEXT,"         "
		dc.b	"CharactersGfx/Katrina.gfx",ENDTEXT,"  "
		dc.b	1		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"003E origine sconosciuta",ENDTEXT,"        "	;char 1
		dc.b	"Clavius",ENDTEXT,"                         "
		dc.b	"Umanoide, 176 anni",ENDTEXT,"              "
		dc.b	"Pilota",ENDTEXT,"                          "
		dc.b	"Clavius",ENDTEXT,"         "
		dc.b	"CharactersGfx/Clavius.gfx",ENDTEXT,"  "
		dc.b	2		;gender (0=male, 1=female, 2=n/a)
...
********************************************************************************
		...
		dc.b	"00-98CC Earth",ENDTEXT,"                   "	;char 2
		dc.b	"Siygess, Cheule",ENDTEXT,"                 "
		dc.b	"Donna, 27 anni",ENDTEXT,"                  "
		dc.b	"Cittadina terrestre",ENDTEXT,"             "
		dc.b	"Cheule",ENDTEXT,"          "
		dc.b	"CharactersGfx/Cheule.gfx",ENDTEXT,"   "
		dc.b	1		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"04-56FE Tesseract",ENDTEXT,"               "	;char 3
		dc.b	"MC 128-7 CIM",ENDTEXT,"                    "
		dc.b	"Meccanoide, 6 anni",ENDTEXT,"              "
		dc.b	"Fante da combattimento",ENDTEXT,"          "
		dc.b	"CIM",ENDTEXT,"             "
		dc.b	"CharactersGfx/CIM.gfx",ENDTEXT,"      "
		dc.b	2		;gender (0=male, 1=female, 2=n/a)
		dc.b	1		;race
...
********************************************************************************
		...
		dc.b	"01-A45D New Europe",ENDTEXT,"              "	;char 4
		dc.b	"Desverger",ENDTEXT,"                       "
		dc.b	"Uomo, 42 anni",ENDTEXT,"                   "
		dc.b	"Killer freelance",ENDTEXT,"                "
		dc.b	"Desverger",ENDTEXT,"       "
		dc.b	"CharactersGfx/Desverger.gfx",ENDTEXT,""
		dc.b	0		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"07-0453 Cassandra",ENDTEXT,"               "	;char 5
		dc.b	"Reannon, Adele",ENDTEXT,"                  "
		dc.b	"Donna, 31 anni",ENDTEXT,"                  "
		dc.b	"Esperta in sistemi di sicurezza",ENDTEXT," "
		dc.b	"Adele",ENDTEXT,"           "
		dc.b	"CharactersGfx/Adele.gfx",ENDTEXT,"    "
		dc.b	1		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"00-0027 New Europe",ENDTEXT,"              "	;char 6
		dc.b	"Torre, Miyriel",ENDTEXT,"                  "
		dc.b	"Automa, 100 anni",ENDTEXT,"                "
		dc.b	"Interfaccia IV",ENDTEXT,"                  "
		dc.b	"Miyriel",ENDTEXT,"         "
		dc.b	"CharactersGfx/Miyriel.gfx",ENDTEXT,"  "
		dc.b	2		;gender (0=male, 1=female, 2=n/a)
		dc.b	4		;race
...
********************************************************************************
		...
		dc.b	"Deevergh, Rorian",ENDTEXT,"                "
		dc.b	"Uomo, 42 anni",ENDTEXT,"                   "
		dc.b	"Combattente esperto",ENDTEXT,"             "
		dc.b	"Rorian",ENDTEXT,"          "
		dc.b	"CharactersGfx/Rorian.gfx",ENDTEXT,"   "
		dc.b	0		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"A037 origine sconosciuta",ENDTEXT,"        "	;char 8
		dc.b	"Freymon, Jenillee",ENDTEXT,"               "
		dc.b	"Donna, 27 anni",ENDTEXT,"                  "
		dc.b	"Medico di guerra",ENDTEXT,"                "
		dc.b	"Jenillee",ENDTEXT,"        "
		dc.b	"CharactersGfx/Jenillee.gfx",ENDTEXT," "
		dc.b	1		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"04-154E Tesseract",ENDTEXT,"               "	;char 12
		dc.b	"Kiurcher",ENDTEXT,"                        "
		dc.b	"Uomo, 49 anni",ENDTEXT,"                   "
		dc.b	"Tiratore scelto",ENDTEXT,"                 "
		dc.b	"Kiurcher",ENDTEXT,"        "
		dc.b	"CharactersGfx/Kiurcher.gfx",ENDTEXT," "
		dc.b	0		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"08-32EE Starscape",ENDTEXT,"               "	;char 10
		dc.b	"Spey, Bonden",ENDTEXT,"                    "
		dc.b	"Uomo, 22 anni",ENDTEXT,"                   "
		dc.b	"Cittadino",ENDTEXT,"                       "
		dc.b	"Bonden",ENDTEXT,"          "
		dc.b	"CharactersGfx/Bonden.gfx",ENDTEXT,"   "
		dc.b	0		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"56-AA56 Freewill",ENDTEXT,"                "	;char 12
		dc.b	"CIM-Lite",ENDTEXT,"                        "
		dc.b	"Meccanoide, 2 anni",ENDTEXT,"              "
		dc.b	"Fante da combattimento",ENDTEXT,"          "
		dc.b	"CIM-Lite",ENDTEXT,"        "
		dc.b	"CharactersGfx/CIM-Lite.gfx",ENDTEXT," "
		dc.b	2		;gender (0=male, 1=female, 2=n/a)
...
********************************************************************************
		...
		dc.b	"003E origen desconocido",ENDTEXT,"         "	;char 1
		dc.b	"Clavius",ENDTEXT,"                         "
		dc.b	"Humanoide, 176 a§os",ENDTEXT,"             "
		dc.b	"Piloto",ENDTEXT,"                          "
		dc.b	"Clavius",ENDTEXT,"         "
		dc.b	"CharactersGfx/Clavius.gfx",ENDTEXT,"  "
		dc.b	2		;gender (0=male, 1=female, 2=n/a)
...
********************************************************************************
		...
		dc.b	"00-98CC Earth",ENDTEXT,"                   "	;char 2
		dc.b	"Siygess, Cheule",ENDTEXT,"                 "
		dc.b	"Hembra humana, 27 a§os",ENDTEXT,"          "
		dc.b	"Ciudadana de la tierra",ENDTEXT,"          "
		dc.b	"Cheule",ENDTEXT,"          "
		dc.b	"CharactersGfx/Cheule.gfx",ENDTEXT,"   "
		dc.b	1		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"04-56FE Tesseract",ENDTEXT,"               "	;char 3
		dc.b	"MC 128-7 CIM",ENDTEXT,"                    "
		dc.b	"Mecanismo, 6 a§os",ENDTEXT,"               "
		dc.b	"Series de combate de infanter°a",ENDTEXT," "
		dc.b	"CIM",ENDTEXT,"             "
		dc.b	"CharactersGfx/CIM.gfx",ENDTEXT,"      "
		dc.b	2		;gender (0=male, 1=female, 2=n/a)
		dc.b	1		;race
...
********************************************************************************
		...
		dc.b	"01-A45D New Europe",ENDTEXT,"              "	;char 4
		dc.b	"Desverger",ENDTEXT,"                       "
		dc.b	"Var¢n humano, 42 a§os",ENDTEXT,"           "
		dc.b	"Asesino a cuenta propia",ENDTEXT,"         "
		dc.b	"Desverger",ENDTEXT,"       "
		dc.b	"CharactersGfx/Desverger.gfx",ENDTEXT,""
		dc.b	0		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"07-0453 Cassandra",ENDTEXT,"               "	;char 5
		dc.b	"Reannon, Adele",ENDTEXT,"                  "
		dc.b	"Hembra humana, 31 a§os",ENDTEXT,"          "
		dc.b	"Experta en seguridad",ENDTEXT,"            "
		dc.b	"Adele",ENDTEXT,"           "
		dc.b	"CharactersGfx/Adele.gfx",ENDTEXT,"    "
		dc.b	1		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"00-0027 New Europe",ENDTEXT,"              "	;char 6
		dc.b	"Torre, Miyriel",ENDTEXT,"                  "
		dc.b	"Androide, 100 a§os",ENDTEXT,"              "
		dc.b	"Interfaz serie IV",ENDTEXT,"               "
		dc.b	"Miyriel",ENDTEXT,"         "
		dc.b	"CharactersGfx/Miyriel.gfx",ENDTEXT,"  "
		dc.b	2		;gender (0=male, 1=female, 2=n/a)
		dc.b	4		;race
...
********************************************************************************
		...
		dc.b	"Deevergh, Rorian",ENDTEXT,"                "
		dc.b	"Var¢n humano, 42 a§os",ENDTEXT,"           "
		dc.b	"Combatiente especializado",ENDTEXT,"       "
		dc.b	"Rorian",ENDTEXT,"          "
		dc.b	"CharactersGfx/Rorian.gfx",ENDTEXT,"   "
		dc.b	0		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"A037 origen desconocido",ENDTEXT,"         "	;char 8
		dc.b	"Freymon, Jenillee",ENDTEXT,"               "
		dc.b	"Hembra humana, 27 a§os",ENDTEXT,"          "
		dc.b	"MÇdico de campo de batalla",ENDTEXT,"      "
		dc.b	"Jenillee",ENDTEXT,"        "
		dc.b	"CharactersGfx/Jenillee.gfx",ENDTEXT," "
		dc.b	1		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"04-154E Tesseract",ENDTEXT,"               "	;char 12
		dc.b	"Kiurcher",ENDTEXT,"                        "
		dc.b	"Var¢n humano, 49 a§os",ENDTEXT,"           "
		dc.b	"Tirador",ENDTEXT,"                         "
		dc.b	"Kiurcher",ENDTEXT,"        "
		dc.b	"CharactersGfx/Kiurcher.gfx",ENDTEXT," "
		dc.b	0		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"08-32EE Starscape",ENDTEXT,"               "	;char 10
		dc.b	"Spey, Bonden",ENDTEXT,"                    "
		dc.b	"Var¢n humano, 22 a§os",ENDTEXT,"           "
		dc.b	"Ciudadano",ENDTEXT,"                       "
		dc.b	"Bonden",ENDTEXT,"          "
		dc.b	"CharactersGfx/Bonden.gfx",ENDTEXT,"   "
		dc.b	0		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
...
********************************************************************************
		...
		dc.b	"Homez, Katrina",ENDTEXT,"                  "
		dc.b	"Hembra humana, 27 a§os",ENDTEXT,"          "
		dc.b	"Antigua agente del DPU",ENDTEXT,"          "
		dc.b	"Katrina",ENDTEXT,"         "
		dc.b	"CharactersGfx/Katrina.gfx",ENDTEXT,"  "
		dc.b	1		;gender (0=male, 1=female, 2=n/a)
		dc.b	0		;race
